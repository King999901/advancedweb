...
const Hero = () => {
  return (
    <section id="hero" className="relative bg-[#EAE7FF] h-screen flex items-center justify-center overflow-hidden">
      {/* المان‌های پس‌زمینه */}
      ...
      <div className="max-w-4xl mx-auto px-6 text-center space-y-6 relative z-10">
        ...
        <p className="text-lg md:text-xl text-[#4B3F72] animate-slide-up delay-200">
          با دوره‌ وب ۲ ما، پروژه‌های واقعی بسازید و دانش خود را ارتقا دهید.
        </p>
